...
const User = require('../dist/models/mongodb/User.model').default;
const TestPrice = require('../dist/models/mongodb/TestPrice.model').default;
const LabArticle = require('../dist/models/mongodb/LabArticle.model').default;
