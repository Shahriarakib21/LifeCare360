        ...
        <div className="max-w-4xl mx-auto space-y-6 pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-1">
                    <button className="w-full text-left px-4 py-2 rounded-lg bg-primary-50 text-primary-700 font-medium flex items-center gap-2">
                        <Settings className="w-4 h-4" /> General
                    </button>
                    <button className="w-full text-left px-4 py-2 rounded-lg hover:bg-secondary-50 text-secondary-600 flex items-center gap-2">
                ...
                <div className="md:col-span-2 space-y-6">
                    {/* General Settings */}
                    <Card title="General Configuration" icon={<Settings className="w-5 h-5 text-primary-600" />}>
                    ...
                    <Card title="Administrative Information" icon={<Info className="w-5 h-5 text-primary-600" />}>
